...
MCLATEST=$(jq -r ".builds[-1]" ./version.json)

MCAPI=

#https://api.purpurmc.org/v2/purpur/1.21.3
#https://api.papermc.io/v2/projects/waterfall/versions/1.21
#https://api.papermc.io/v2/projects/velocity
#https://mohistmc.com/api/v2/projects/mohist/1.20.1/builds
#
#https://download.geysermc.org/v2/projects/geyser/versions/latest/builds/latest/downloads/fabric
#https://github.com/GeyserMC/Hydraulic
#https://geysermc.org/wiki/other/hurricane/
#
#
#

function javaInstall() {
    local MCJAVA=$($MCVERSION && cut -d "." -f2)
