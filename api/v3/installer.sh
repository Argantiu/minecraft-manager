...
if ! command -v sudo $AGDEBUG; then apt-get install sudo -y $AGDEBUG
fi
if ! command -v zip $AGDEBUG; then apt-get install zip -y $AGDEBUG
fi
if ! command -v xargs $AGDEBUG; then apt-get install findutils -y $AGDEBUG
fi
if ! command -v diff $AGDEBUG; then apt-get install diffutils -y $AGDEBUG
fi
